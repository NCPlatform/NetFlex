...
<style>
.security_content {margin-top: 10px; padding: 0px 15px 20px 15px; box-shadow: 0px 1px 5px 1px inset;}
#securityContent {text-align: left; font-size: 16px; white-space: pre-line;}
#securityContent strong {font-weight: 900;}
</style>
