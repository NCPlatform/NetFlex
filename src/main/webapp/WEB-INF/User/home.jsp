...
<main>
        <div class="container">
            <div class="movie-main">
                <img src="/NetFlex/asset/image/masklogo.png" alt="">
                <br>
                <br>
                <br>
						...
						<c:forEach var="movie" items="${movies}" varStatus="loop" begin="${group * 5}" end="${group * 5 + 4}">
							<div class="col">
								...
								<div class="button-container">
									...
									<button class="btn btn-primary details-button2" id="openModal"
											data-seq-movie="${movie.seqMovie}"
											data-title="${movie.title}"
											data-story="${movie.story}"
											data-nation="${movie.nation}"
...
/* 좋아요 버튼 기능 */
     function handleLikeButtonClick() {
        var likeCountElement = document.querySelector('#likeButton #likeCount');
        ...
        $('button[data-seq-movie='+seqMovie+'][id="openModal"]').attr('data-liked',likeCount);
