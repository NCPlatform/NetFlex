...
<div class="p-3 mb-2 bg-black">
        ...
        <div class="carousel-inner">
            <c:forEach var="group" begin="0" end="2">
                <div class="carousel-item ${group == 0 ? 'active' : ''}">
                    <div class="row">
                        <c:forEach var="movie" items="${movies}" varStatus="loop" begin="${group * 5}"
                                   end="${group * 5 + 4}">
                            <div class="col">
    ...
    <div class="carousel-category">외국 영화 & 드라마</div>
    ...
    <div id="carouselExample4" class="carousel slide" data-bs-interval="false">
        ...
        <div class="carousel-inner">
            <c:forEach var="group" begin="0" end="2">
                <div class="carousel-item ${group == 0 ? 'active' : ''}">
                    <div class="row">
                        <c:forEach var="movie" items="${likeMovie}" varStatus="loop" begin="${group * 5}"
                                   end="${group * 5 + 4}">
                            <div class="col">
                                <img src="${movie.thumbnailSrcUrl}" class="d-block w-100" alt="...">
                                <div class="button-container">
    ...
    <!-- MaskModal -->
    <div class="modal fade dark-mode" id="videoModal2" tabindex="-1" aria-labelledby="exampleModalLabel"
