...
<link rel="stylesheet" href="/NetFlex/asset/owlcarousel/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="/NetFlex/asset/owlcarousel/assets/owl.theme.default.min.css">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a id="home" class="nav-link" href="/NetFlex/movie/home">홈</a>
              </li>
              <li class="nav-item">
                <a id="series" class="nav-link" href="/NetFlex/user/series">시리즈</a>
              </li>
              <li class="nav-item">
                <a id="movie" class="nav-link" href="/NetFlex/user/movie">영화</a>
              </li>
              <li class="nav-item">
                <a id="newContents" class="nav-link" href="/NetFlex/user/newContents">NEW! 요즘 대세 콘텐츠</a>
              </li>
              <li class="nav-item">
                <a id="dibsList" class="nav-link" href="/NetFlex/user/dibsList">내가 찜한 리스트</a>
              </li>
            </ul>
          </div>
        </div>
