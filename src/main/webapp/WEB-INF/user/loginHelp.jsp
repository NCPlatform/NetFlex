    ...
    <div id="appMountPoint">
        <div class="login-wrapper">
            <div class="login-wrapper-background login-wrapper-default"></div>
				<a href="../index.jsp"; >
					<img alt="넷플릭스홈" src="../asset/img/imagelogo.png" style="width: 199px; height: 80px;" background-color: white;>                        
				</a>
            <div class="login-body">
                         
            <section>
				<div class="card" style="width: 350px; background-color: gray; height: 400px">
				  <div class="card-body">
				    <h1 class="card-title",font-family: 'Oswald', sans-serif;>
  ...
  &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary"><a href="/NetFlex/user/find_email_form" class="card-link">이메일 찾기</a></button>
            ...
            <div class="site-footer-wrapper centered">
                ...
                <div class="site-footer">
                    <p class="footer-top">
                        질문이 있으신가요? 문의 전화:  <a class="footer-top-a" href="tel:080-001-9587">080-001-9587</a>
                    </p>
