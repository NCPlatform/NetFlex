...
<!--네이버 로그인 -->
                    ...
                    <div class="hybrid-login-form-help">
                        ...
                        <a href="/NetFlex/user/loginHelp";>도움이 필요하신가요?</a>
...
<!-- 회원가입창으로 보내기 -->Netflix 회원이 아닌가요? <a class="" target="_self" href="/NetFlex/index.jsp">지금 가입하세요</a>
...
<script type="text/javascript">
  	var naver_id_login = new naver_id_login("2BVZpS8LeJiU8cRyQL8N", "http://localhost:8080/NetFlex/user/loginOk");
  										//developers.naver의 Client ID
  	var state = naver_id_login.getUniqState();
  	naver_id_login.setButton("white", 2,40);
  	naver_id_login.setDomain("http://localhost:8080/NetFlex/user/loginForm");//소셜로그인을 하는 주소
