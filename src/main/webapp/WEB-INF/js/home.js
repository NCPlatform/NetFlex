$(document).ready(function() {
    ...
    $('#openWatchJSP').click(function() {
        window.location.href = '/NetFlex/user/watch';  // Replace with the correct path to watch.jsp

    });
    // id=openNewModal 클릭시 모달에 유튜브 띄우기
    $('#openNewModal').click(function() {
        var videoUrl = 'https://www.youtube.com/embed/IOWo0QruiS8';  // Modify with the desired video URL
